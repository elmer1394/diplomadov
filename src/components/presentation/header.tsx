    ...
    <ThemeProvider>
      ...
      <header className="h-full w-screen place-items-center bg-white relative px-8 py-8 lg:mb-36">
        <div className="container mx-auto grid items-center lg:grid-cols-2">
          <div className="text-center lg:text-left pt-32">
            <div className="mb-8 inline-flex items-center">
              ...
              >
                BIBLIOTECA CARRERA INGENIERIA AGRONOMICA
              </Typography>
              <Typography
                color="dark"
                variant="small"
            ...
            >
              Mira nuestros nuevos libros <span className="text-blue">recien actualizados</span>
            </Typography>
            <Typography variant="lead" color="blue-gray" className="lg:pr-32">
              Llearon los nuevos libros de la especialidad de zootecnia y agroambiente buscalo en los ambientes de la biblioteca.
            </Typography>
        ...
        <div className="hidden lg:flex">
          <img src="agro.jpg" alt="components" className="absolute -top-10 right-0 w-1/2" />
        </div>
      </header>
    </ThemeProvider>
  );
